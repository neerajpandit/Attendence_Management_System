  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 p-6">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-8">
        ...
        <div className="bg-white p-6 rounded-2xl shadow hover:shadow-lg transition text-center">
          <h3 className="text-lg font-semibold text-gray-700">Leave</h3>
          <p className="text-3xl font-bold text-yellow-600">{totalLeave}</p>
        </div>
        <div className="bg-white p-6 rounded-2xl shadow hover:shadow-lg transition text-center">
          <h3 className="text-lg font-semibold text-gray-700">Late</h3>
          <p className="text-3xl font-bold text-orange-600">{totalLate}</p>
        </div>
      </div>
          ...
          <tbody>
            {punchData.map((entry, index) => (
              <tr key={index} className="border-b hover:bg-gray-50">
                ...
                <td className="p-3 text-gray-700">{entry.inTime}</td>
                <td className="p-3 text-gray-700">{entry.outTime}</td>
